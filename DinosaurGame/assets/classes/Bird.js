class Bird {
    ...
    constructor(gameContext) {
      ...
      this.shape.src = "assets/img/bird.png";
      this.positionX = this.gameContext.canvas.width;
      this.positionY = 200;
  
      this.shape.onload = (() => {
        console.log('draw image');
        this.gameContext.ctx.drawImage(this.shape, 0, 0, 200, 200, this.gameContext.canvas.width, this.gameContext.canvas.height, 75, 75);
      })
    }
    move = (() => {
